...
from ModelingMachine.metablueprint.mb8_6_6 import Metablueprint


class TestMB8_6_6(BaseTestMB):
    ...
    @pytest.mark.skip('MB8.6.6 does not handle text-only datasets well')
