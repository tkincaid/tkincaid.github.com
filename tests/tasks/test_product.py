...
from ModelingMachine.engine.tasks.s2w_transformer import mmPRODUCT


class TestmmPRODUCT(unittest.TestCase):
    """ Test suite for mmPRODUCT
    """
    ...
    def test_fit(self):
        ...
        fit_result.new_products[key]
        self.assertEqual(fit_result.new_products[key] == ['X2_XX_X3'], True)
    ...
    def test_unique_col(self):
        ...
        task = mmPRODUCT()
        fit_result = task.fit(X, Y, Z)
        self.assertEqual(fit_result.new_products[key] == [], True)
